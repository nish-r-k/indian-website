...
const jobCards = [
  { id: 1, title: "UI/UX DESIGNER", location: "Bangalore (Hybrid)", type: "Full-Time", gradient: "from-[#E7E9EC] to-[#D7DADE]" },
  { id: 2, title: "REACT DEVELOPER", location: "Remote", type: "Full-Time", gradient: "from-[#DCD4E8] to-[#CBBEDC]" },
  { id: 3, title: "DEVOPS ENGINEER", location: "Bangalore (Office)", type: "Full-Time", gradient: "from-[#EFEFEF] to-[#E3E1DD]" },
  { id: 4, title: "MARKETING LEAD", location: "Remote", type: "Internship", gradient: "from-[#EBDFEC] to-[#D7C9DA]" },
  { id: 5, title: "FULL-STACK DEVELOPER", location: "Remote", type: "Full-Time", gradient: "from-[#F5F5F6] to-[#E5E5E6]" },
  { id: 6, title: "GRAPHIC DESIGNER", location: "Remote", type: "Internship", gradient: "from-[#DCE1EA] to-[#C8CDD7]" },
  { id: 7, title: "FULL-STACK PHP DEVELOPER", location: "Remote", type: "Full-Time", gradient: "from-[#EBDFEC] to-[#D7C9DA]" },
  { id: 8, title: "CLOUD DEVELOPER", location: "Hybrid (Bangalore)", type: "Full-Time", gradient: "from-[#DCE1EA] to-[#C7CDD7]" },
  { id: 9, title: "APP DEVELOPER", location: "Remote", type: "Full-Time", gradient: "from-[#E6DDED] to-[#D3C5DA]" },
  { id: 10, title: "FULL-STACK AI DEVELOPER", location: "Remote", type: "Full-Time", gradient: "from-[#FFFFFF] to-[#E8E8E8]" },
];
  ...
  return (
    <div className="w-full px-10 py-16">
      ...
      <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        >
          <div className="relative h-24">
            <svg className="absolute top-3 left-0 opacity-70" width="180" height="60" viewBox="0 0 180 60">
              <path
                d="M 0 40 Q 50 10 100 40 T 180 40"
                stroke="#C9A3E8"
                strokeWidth="3"
          ...
          <h2 className="text-4xl font-semibold mt-10 leading-tight" style={{ color: "#C9A3E8" }}>
            Our Core <br /> Values
          </h2>
        </motion.div>
      ...
      >
        {jobCards.map((job) => (
          <motion.div
            key={job.id}
            className={`p-8 rounded-2xl shadow-sm border bg-gradient-to-br cursor-pointer ${job.gradient}`}
          ...
          >
            ...
            <p className="text-gray-700 text-sm">💼 {job.type}</p>
          </motion.div>
        ))}
      </motion.div>
    </div>
