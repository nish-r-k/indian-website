...
//           // Hide arrow after rotation completes (1 second rotation + 0.5s delay)
//           setTimeout(() => {
//             setShowArrow(false);
//           }, 1500);
...
//     <div 
//       ref={sectionRef}
//       className="relative w-full min-h-screen bg-white flex items-center justify-center px-4 sm:px-6 md:px-8 lg:px-12 py-12 md:py-16 lg:py-20"
//     >
//       <div className="w-full max-w-7xl mx-auto">
//         {/* Main Content Block */}
//         <div className="relative bg-[#1A3636] rounded-[40px] sm:rounded-[50px] md:rounded-[60px] p-6 sm:p-8 md:p-12 lg:p-16 xl:p-20 min-h-[500px] sm:min-h-[550px] md:min-h-[600px] lg:min-h-[700px] flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 overflow-hidden">
...
//       tagline: 'Creative solutions that elevate your brand.',
//       description: 'We provide comprehensive design support to bring your vision to life. Our approach includes:',
//       features: [
...
//                   expandedCards[index] ? 'md:flex md:gap-6 lg:gap-8' : ''
//                 }`}
//               >
...
//                     <div className="flex-1 bg-gray-700 rounded-[30px] sm:rounded-[40px] md:rounded-[50px] p-6 sm:p-8 md:p-10 lg:p-12 min-h-[300px] sm:min-h-[350px] md:min-h-[400px] flex flex-col justify-center">
...
//                     <div className="flex-1 bg-[#A9D2FF] rounded-[30px] sm:rounded-[40px] md:rounded-[50px] p-6 sm:p-8 md:p-10 lg:p-12 min-h-[300px] sm:min-h-[350px] md:min-h-[400px] flex flex-col items-center justify-center text-center">
